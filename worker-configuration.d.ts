/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 57bb3b2e9c11d69b44b170ed12fd70e9)
// Runtime types generated with workerd@1.20260828.1 2026-08-28 nodejs_compat
interface __BaseEnv_Env {
	USAGE: KVNamespace;
	EXERCISES: KVNamespace;
	AI_RATE_LIMITER: RateLimit;
	ASSETS: Fetcher;
	OPENAI_MODEL: "gpt-5.6-sol";
	MAX_DAILY_AI_UNITS: "120";
	OPENAI_API_KEY: string;
	TUTOR_STATE_SECRET: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OPENAI_MODEL" | "MAX_DAILY_AI_UNITS" | "OPENAI_API_KEY" | "TUTOR_STATE_SECRET" | "RATE_LIMIT_SALT">> {}
}
